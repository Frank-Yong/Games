...
$nextday = date('Y-m-d',strtotime("+0 day"));

$sql = "SELECT a.id, a.userId_1, a.userId_2 
		FROM invitatiemeci a 
		WHERE a.accepted=1 and (a.userId_1=165 or a.userId_2=165) and a.datameci='".$nextday."' ORDER BY a.id ASC";
echo "$sql<br/>";
