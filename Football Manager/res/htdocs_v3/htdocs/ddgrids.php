...
while(list($fname, $lname) = mysql_fetch_row($res)) {
?>
	<li class="ui-widget-content ui-corner-tr">
		<h5 class="ui-widget-header"><?php echo $fname.' '.$lname; ?></h5>
		<a href="link/to/trash/script/when/we/have/js/off" title="Titular" class="ui-icon ui-icon-trash">Titular</a>
	</li>
<?php
} 
