	...
	<td colspan="7" align="center">
		...
		<table class="tf2" width="100%">
			<tr>
				...
				<?php
				/*
				$sql = "SELECT competitieid FROM ligauser WHERE userid=".$_SESSION['USERID']. " AND sezon=".$_SESSION['_SEZON'];
				$resu = mysqli_query($GLOBALS['con'],$sql);
				list($competitieuser) = mysqli_fetch_row($resu);
				...
				*/
				...
				<th colspan="2">
				<input type="Submit" name="AfisareClasament" value="Show" class="button-2">
				</th>
			</tr>
		</table>
		</form>
					...
					<tr>
						...
						<th><font color="<?php echo $gk; ?>">Point</font></th>
					</tr>
...
?>
					...
					<tr>
						...
						<th><a href="index.php?option=viewclub&club_id=<?php echo $echipaid; ?>" class="link-3"><?php echo $echipa; ?></a></th>
						<!--
					...
					<tr>
						...
						<td><a href="index.php?option=viewclub&club_id=<?php echo $echipaid; ?>" class="link-3"><div class="div-3"><?php echo $echipa; ?></div></a></td>
						<!--
...
<tr>
	...
	$sql = "SELECT a.id, a.userId_1, a.userId_2, a.score, a.gamedate, b.TeamName, c.TeamName
			...
			LEFT JOIN user c
			ON c.id=a.userId_2
			WHERE a.etapa=$getapa AND a.competitionid=$competitie AND a.accepted=1";
	//echo "$sql";
	...
	?>
	<tr>
		<th colspan="3" align="center"><?php echo "Round. $getapa<br/>".$dmeci.' 12:00'; ?></th>
	</tr>
		<?php } ?>
	<tr>
