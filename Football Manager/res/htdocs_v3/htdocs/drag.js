...
REDIPS.drag = (function () {
	...
	var	init,					// initialization
		...
		cloned_flag = 1,		// if object is cloned, flag gets value 1
		...
		drop_option = 'single',	// (string) drop_option has three options: multiple, single and switch
	...
	save_content = function () {
		...
		// display query string
			...
			//window.open('/my/multiple-parameters.php?' + query, 'Mypop', 'width=330,height=140,scrollbars=yes');
			window.open('multiple-parameters.php?' + query, 'Mypop', 'width=330,height=140,scrollbars=yes');
		}
	};
