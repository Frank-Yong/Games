...
//echo "$sql<br/>";
		...
		$resc = mysql_query($sqlc);
			list($caracteristica) = mysql_fetch_row($resc);
			...
			if($p_array['accidentat'] == 1) {
				//jucatorul este accidentat
				//apare un red cross in dreptul lui
				$acc =  "<img src=\"images/injured.png\" width=\"17\">";
			} 

			if($p_array['training'] == 1) {
				$tr =  "<img src=\"images/respecializare.png\" width=\"20\" title=\"Respecializare\">";
			}
...
class Stadium {
	...
	function BuildStadium() {
		echo "<div class=\"hr-replace\"></div>";
		echo "<h2>".translate('Increase capacity')."!</h2><br/><font color=\"red\">(Priceul de constructie al unui scaun este 500 &euro;. Marirea capacitatii stadionului se face doar daca exista fonduri suficiente pentru constructie. In perioada de constructie, acel sector nu va fi Available pentru spectatori. Cu cat sunt mai multe sectoare in constructie, cu atat durata de finalizare este mai mare!)</font>";
