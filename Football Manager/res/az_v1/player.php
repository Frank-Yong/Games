...
class Player {
	...
	private function Viewleap() {
		...
		$res = mysql_query($sql);
		$i=0;
		while(list($Characteristic, $data) = mysql_fetch_row($res)) {
			if($i==0) {
		...
		if($this->Transfer == 1) {
			...
			if($this->TransferDeadline == "0000-00-00 00:00:00") {
				...
				if($this->TransferDeadline<=Date("Y-m-d H:i:00")) {
					...
					//echo date('H', $date);
					echo "<h3>Pariere inceputa ($deafi - $bsuma &euro;)! Expira pe ".$date."!<input class=\"input-1\" type=\"text\" name=\"BidValue\" value=\"$bid_depariat\" $disabled> &euro; <input type=\"Submit\" name=\"BidPlayer\" value=\"Ofera\" $disabled class=\"button-2\"></h3>";
					if($this->UserID == 0) {
						//trebuie sa se liciteze salariul
						echo "<h3>Jucator liber de transfer. Va fi achizitionat de cine ofera salariul saptamanal cel mai mare!</h3>";
					}
...
//		echo "<img src=\"images/missing_player.jpg\" class=\"img-1\" width=\"180\"  align=\"left\">";
		...
		echo "Saptamani la club: ".$this->weeks.'<br/>';
		...
		//echo "$sql<br/>";
		$res = mysql_query($sql);
		list($Characteristic) = mysql_fetch_row($res);
		mysql_free_result($res);
			...
			<h3 class="mb-30">Table</h3>
				<div class="progress-table-wrap">
					<div class="progress-table">
						<div class="table-row">
							<div class="country"><font color="<?php echo $gk; ?>"><?php echo translate('Reflexes'); ?></font></div>
							<div class="country"><font color="<?php echo $gk; ?>"><?php echo translate('OneonOne'); ?></font></div>
							<div class="country"><font color="<?php echo $gk; ?>"><?php echo translate('Handling'); ?></font></div>
							<div class="country"><font color="<?php echo $df; ?>"><?php echo translate('Tackling'); ?></font></div>
							<div class="country"><font color="<?php echo $df; ?>"><?php echo translate('Marking'); ?></font></div>
							<div class="country"><font color="<?php echo $dffw; ?>"><?php echo translate('Heading'); ?></font></div>
							<div class="country"><font color="<?php echo $md; ?>"><?php echo translate('LongShot'); ?></font></div>
							</div>
						<div class="table-row">
							<div class="country"><?php ColorIt($this->reflexes); echo $img_ref; ?></div>
							<div class="country"><?php ColorIt($this->OneOnOne); echo $img_ooo; ?></div>
							<div class="country"><?php ColorIt($this->Handling); echo $img_han; ?></div>
							<div class="country"><?php ColorIt($this->Tackling); echo $img_tack; ?></div>
							<div class="country"><?php ColorIt($this->Marking); echo $img_mark; ?></div>
							<div class="country"><?php ColorIt($this->Heading); echo $img_head; ?></div>
							<div class="country"><?php ColorIt($this->LongShot); echo $img_long; ?></div>
						</div>
						<div class="table-row">
							<div class="country"><font color="<?php echo $md; ?>"><?php echo translate('Positioning'); ?></font></div>
							<div class="country"><font color="<?php echo $fw; ?>"><?php echo translate('Shooting'); ?></font></div>
							<div class="country"><font color="<?php echo $md; ?>"><?php echo translate('FirstTouch'); ?></font></div>
							<div class="country"><font color="<?php echo $md; ?>"><?php echo translate('Creativity'); ?></font></div>	
							<div class="country"><font color="<?php echo $md; ?>"><?php echo translate('Crossing'); ?></font></div>	
							<div class="country"><font color="<?php echo $md; ?>"><?php echo translate('Passing'); ?></font></div>
							<div class="country"><font color="<?php echo $gk; ?>"><?php echo translate('Communication'); ?></font></div>
						</div>

						<div class="table-row">
							<div class="country"><?php ColorIt($this->Positioning); echo $img_pos; ?></div>
							<div class="country"><?php ColorIt($this->Shooting); echo $img_shoot; ?></div>
							<div class="country"><?php ColorIt($this->FirstTouch); echo $img_first; ?></div>	
							<div class="country"><?php ColorIt($this->Creativity); echo $img_crea; ?></div>	
							<div class="country"><?php ColorIt($this->Crossing); echo $img_cros; ?></div>
							<div class="country"><?php ColorIt($this->Passing); echo $img_pass; ?></div>
							<div class="country"><?php ColorIt($this->Communication); echo $img_com; ?></div>
						</div>
						
						<div class="table-row">
							<div class="country"><?php echo translate('TeamWork'); ?></div>
							<div class="country"><?php echo translate('Conditioning'); ?></div>
							<div class="country"><?php echo translate('Speed'); ?></div>
							<div class="country"><?php echo translate('Experience'); ?></div>	
							<div class="country"><?php echo translate('Condition'); ?></div>	
							<div class="country"><?php echo translate('Dribbling'); ?></div>
							<div class="country"><?php echo translate('Aggresivity'); ?></div>
						</div>
						<div class="table-row">
							<div class="country"><?php ColorIt($this->TeamWork); echo $img_team; ?></div>
							<div class="country"><?php ColorIt($this->Strength); echo $img_stre; ?></div>
							<div class="country"><?php ColorIt($this->Speed); echo $img_speed; ?></div>	
							<div class="country"><?php ColorIt($this->Experience); echo $img_exp; ?></div>	
							<div class="country"><?php ColorIt($this->Condition); echo $img_cond; ?></div>
							<div class="country"><?php ColorIt($this->Dribbling); echo $img_drib; ?></div>
							<div class="country"><?php ColorIt($this->Aggresivity); echo $img_agre; ?></div>
						</div>
					</div>
				</div>
...
<?php
		...
		//echo $this->TransferDeadline.'<br/>';
		if($this->UserID == $_SESSION['USERID'] && $this->TransferDeadline == "0000-00-00 00:00:00"){
			echo "<h3>reassign! Fa-l <select name=\"postnou\" class=\"input-2\">";
			for($i=1;$i<11;$i++) {
				switch ($i) {
			...
			echo "<input $disabled type=\"Submit\" name=\"reassign\" value=\"Trimite la training\" class=\"button-22\"></h3>";
		}
		echo "</form>";
