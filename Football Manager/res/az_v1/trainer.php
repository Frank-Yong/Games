...
class Trainer {
	...
	private $CLiga;
	function Trainer($MyLiga=1, $TrainerID=1, $param=1) {
	...
	private function WriteData() {
		...
		fname, lname, Goalkeeping, Defence, Midfield, Attack, Tactical, Motivation, Youth, Wage, Contract, Bonus, Country, poza) 
		VALUES (" .
		...
		mysql_query($sql);
		$this->TrainerID = mysql_insert_id();
	...
	private function GetData() {
		$sql = "SELECT a.id, a.fname, a.lname, a.Goalkeeping, a.Defence, a.Midfield, a.Attack, b.name, a.Contract, a.Wage, a.poza, a.Bonus, d.TeamName, a.Tactical, a.Motivation
				FROM trainer a
				LEFT JOIN country b
				ON a.Country=b.id
		...
		//echo "$sql<br/>";
		$res = mysql_query($sql);
		list($this->TrainerID, $this->FirstName, $this->LastName, $this->Goalkeeping, $this->Defence, $this->Midfield, $this->Attack, $this->Country, $this->Contract, $this->Wage, $this->Poza, $this->Bonus, $this->Echipa, $this->Tactical, $this->Motivation) = mysql_fetch_row($res);
		mysql_free_result($res);
	...
	function EchoTrainer() {
		if($this->TrainerID<1 || $this->TrainerID=="") {
			echo "<table class=\"tftable\"><tr><th>Nu ai nici un antrenor angajat!</th></tr></table>";
		} else {
	...
	//		echo "<img src=\"images/missing_player.jpg\" class=\"img-1\" width=\"180\"  align=\"left\">";
			...
			<tr>
				<th><?php echo "Tactic ";  ?></th>
				<td><?php echo ColorIt($this->Tactical);  ?></td>
			</tr>
			<tr>
				<th><?php echo "Motivare ";  ?></th>
				<td><?php echo ColorIt($this->Motivation);  ?></td>
			</tr>
			<tr>
				<th><?php echo "Salariu: ".number_format($this->Wage)."&euro;/sapt.";  ?></th>
			...
			<th colspan="2">
				...
				<input type="Submit" name="ConcediazaAntrenor" class="button-2" value="Concediaza-l!">
				</form>
			</th>
			</tr>
			<?php } else { ?>
			<tr>
				...
				<input type="Submit" name="Angajeaza" value="Angajeaza-l!" class="button-2">
				</form>
				</th>
			</tr>
			<?php } 
