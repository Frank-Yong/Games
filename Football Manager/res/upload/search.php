...
<tr>
	<td colspan="7">Team name contains: <input type="text" name="NumeEchipa" class="input-nou" value="<?php echo $_REQUEST['NumeEchipa']; ?>"></th>
</tr>		

<tr>
	<th colspan="7">Search player</th>
</tr>		
<tr>
	<td colspan="7">
	Pozitie
	...
	<tr>
		<th><font color="<?php echo $gk; ?>">Reflexes</font></th>
		<th><font color="<?php echo $gk; ?>">One on one</font></th>
		<th><font color="<?php echo $gk; ?>">Handling</font></th>
		<th><font color="<?php echo $df; ?>">Tackling</font></th>	
		<th><font color="<?php echo $df; ?>">Marking</font></th>	
		<th><font color="<?php echo $dffw; ?>">Head game</font></th>
		<th><font color="<?php echo $md; ?>">Long shots</font></th>
	</tr>
	...
	<tr>
		<th><font color="<?php echo $md; ?>">Positioning</font></th>
		<th><font color="<?php echo $fw; ?>">Shooting</font></th>
		<th><font color="<?php echo $md; ?>">Touch</font></th>
		<th><font color="<?php echo $md; ?>">Creativity</font></th>	
		<th><font color="<?php echo $md; ?>">Crossing</font></th>	
		<th><font color="<?php echo $md; ?>">Passing</font></th>
		<th><font color="<?php echo $gk; ?>">Comunication</font></th>
	</tr>
...
<tr>
	<td colspan="7">
	<input type="Submit" name="SearchPlayers" value="Display" class="button-2">
	</td>
</tr>
